...
public class BookAdapterLoan extends FirestoreRecyclerAdapter<Book, BookAdapterLoan.ViewHolder> {
    ...
    /**
     * Vincula los datos al ViewHolder para un elemento en particular en el RecyclerView.
     *
    ...
    //ViewHolder para el RecyclerView que representa un solo elemento de libro.
